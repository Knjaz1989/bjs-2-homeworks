describe('Домашнее задание к занятию 1. «Основные понятия»', () => {
  ...
  describe('Задача №2. Функция должна:', () => {
    ...
    it('верно считать кредит: кейс #7', () => {
      expect(calculateTotalMortgage("15.3", 0, "10000", 36)).toEqual(12532.47);
    });

    it('верно считать кредит: кейс #8', () => {
      expect(calculateTotalMortgage(15, 0, "10000z", 36)).toEqual(false);
    });
  });
});